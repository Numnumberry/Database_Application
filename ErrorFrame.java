public class ErrorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        errorMessage.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        errorMessage.setText("error message");

        okButton.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        okButton.setText("OK");
    ...
    public void setMessage(String str) {        //sets message to be displayed
